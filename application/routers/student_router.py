...
#
# def check_specialisation(specialisation, selected_teachers, vocal_teachers, guitar_teachers):
...
#         return selected_vocal and selected_guitar
#     return True
#
#
# async def update_phone(session, tg_id, phone):
...
#
#
# async def update_student_data(session, tg_id, data, vocal_teachers, guitar_teachers):
...
#
#             if not check_specialisation(new_specialisation_student, data['selected_teachers'], vocal_teachers, guitar_teachers):
#                 return False
#
...
#
#
# async def register_student(session, tg_id, data):
#     student = Student(
#         tg_id=tg_id,
#         date_of_registration=datetime.now(novosibirsk_tz),
#         name=data.get('name'),
...
#     if not phone:
#         await callback.answer(
#             text="Пожалуйста, введите номер телефона для завершения регистрации.",
#             show_alert=True
#         )
#         return
#
...
#
#     if not check_specialisation(specialisation, selected_teachers, vocal_teachers, guitar_teachers):
#         await callback.answer(
...
#
#     async with async_session() as session:
#         await update_phone(session, tg_id, phone)
#
#         if await update_student_data(session, tg_id, data, vocal_teachers, guitar_teachers):
#             message_text = 'Информация успешно обновлена!'
#         else:
#             student = await register_student(session, tg_id, data)
...
#             session.add(StudentTeacher(student_id=student.id, teacher_id=teacher_id))
#
#         await session.commit()
